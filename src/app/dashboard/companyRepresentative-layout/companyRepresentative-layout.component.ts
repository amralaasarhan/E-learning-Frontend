...
@Component({
  selector: 'app-companyRepresentative-layout',
  templateUrl: './companyRepresentative-layout.component.html',
  styleUrls: ['./companyRepresentative-layout.component.css']
})
export class CompanyRepresentativeLayoutComponent implements OnInit {
